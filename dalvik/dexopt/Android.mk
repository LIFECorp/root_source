...
ifeq ($(WITH_JAZZ),true)
LOCAL_SHARED_LIBRARIES += libLLVM libmcld
endif
...
ifeq ($(WITH_JAZZ),true)
    # Create a phony target to build all boot jars.
    include $(CLEAR_VARS)
    LOCAL_MODULE := jazz-aot
    LOCAL_MODULE_TAGS := optional
    LOCAL_ADDITIONAL_DEPENDENCIES := $(JAZZAOT_BOOT_JEXS)
    include $(BUILD_PHONY_PACKAGE)
endif # WITH_JAZZ = true
